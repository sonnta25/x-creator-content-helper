...
- `Extension bridge timed out`: verify extension `0.3.8` or newer is loaded and Auto Run is ON. The Gemini-tab heartbeat should wake Auto Run within 25 seconds, while the runtime watchdog recreates missing alarms; **Run next job** remains available for an immediate check.
