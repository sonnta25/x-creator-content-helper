...
TELEGRAM_FOLLOW_TARGETS_MINUTES=$(Get-EnvValue "TELEGRAM_FOLLOW_TARGETS_MINUTES" "20")
TELEGRAM_FOLLOW_TARGETS_UPDATED_AT=$(Get-EnvValue "TELEGRAM_FOLLOW_TARGETS_UPDATED_AT")
...
FOLLOW_TARGET_BATCH_SIZE=$(Get-EnvValue "FOLLOW_TARGET_BATCH_SIZE" "12")
FOLLOW_TARGET_COOLDOWN_HOURS=$(Get-EnvValue "FOLLOW_TARGET_COOLDOWN_HOURS" "24")
FOLLOW_TARGET_MIN_FOLLOWERS=$(Get-EnvValue "FOLLOW_TARGET_MIN_FOLLOWERS" "100")
FOLLOW_TARGET_MAX_FOLLOWERS=$(Get-EnvValue "FOLLOW_TARGET_MAX_FOLLOWERS" "50000")
FOLLOW_TARGET_HISTORY_PATH=$(Get-EnvValue "FOLLOW_TARGET_HISTORY_PATH" "data/follow_target_history.json")
REPLY_PENDING_QUEUE_CAP=$(Get-EnvValue "REPLY_PENDING_QUEUE_CAP" "5")
...
REPLY_TRACKING_CHECKS_PER_CYCLE=$(Get-EnvValue "REPLY_TRACKING_CHECKS_PER_CYCLE" "8")
...
Write-Host "Setup complete. Try /replytargets, /replyvideo, /followtargets, or /download in Telegram."
