        ...
        *,
        ...
        prompt = _reply_engine_prompt(
            ...
            task=(
                ...
                "Adapt the social posture to the supplied public author reach: for an 8k-50k "
                "mid-tier author, sound like a credible peer and make a specific contribution "
                "the author can naturally continue; for a large or already viral thread, lead "
                "with a compact standalone insight or natural joke that is legible without "
                "extra context. Use 2-4 sentences only when the source genuinely supports depth. "
